// the UpperConfidenceAdjustor is a type of confidence adjustor --
// it calculates upper confidences by ADDING the uncertainty

public class UpperConfidenceAdjustor extends ConfidenceAdjustor {

	public UpperConfidenceAdjustor() {
		super();
	...
	public void calculate(int x, int y) {
		...
		// for upper confidences, we add the uncertainty
